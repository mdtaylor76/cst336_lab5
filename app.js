...
app.get("/", async function(req, res){
    let apiUrl = 'https://api.unsplash.com/photos/random/?client_id=mzAg0OILzU3LHseT4l9vDdH6h6-psdeUX0muJ7ceKLk&featured=true&orientation=landscape';
...
app.get("/search", async function(req, res){
   ...
   let apiUrl = `https://api.unsplash.com/photos/random/?count=9&client_id=mzAg0OILzU3LHseT4l9vDdH6h6-psdeUX0muJ7ceKLk&featured=true&orientation=landscape&query=${keyword}`;
   let response = await fetch(apiUrl);
   let data = await response.json();
   console.log(apiUrl);
